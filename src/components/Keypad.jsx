    ...
    <div className="grid grid-cols-4 gap-3">
      ...
      <div className="col-span-1 flex flex-col gap-3">
         <button
            ...
            className="flex-1 rounded-2xl bg-rose-50 text-rose-600 border border-rose-100 shadow-sm hover:bg-rose-100 hover:border-rose-200 hover:shadow-md active:scale-95 transition-all outline-none focus:ring-2 focus:ring-rose-400 flex items-center justify-center"
          >
            <Delete size={32} />
         </button>
      </div>
